...
export class PhoneComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.phoneService
      ...
      .subscribe(
        (res: HttpResponse<IPhone[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPhones(): void {
    this.eventSubscriber = this.eventManager.subscribe('phoneListModification', () => this.loadPage());
  }
